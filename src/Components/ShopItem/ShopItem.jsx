    ...
    return(
        <div>
            ...
            <div class="logo__wrapper">
                <svg class="logo__svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 369.44 153">
            ...
            <div class="inner__container">
                ...
                <div class="breadcrumbs">
                    <li><a href="../барбершоп/index.html">Главная</a></li>
                    <li><span>МАГАЗИН</span></li>
                    <li><span>СРЕДСТВА ДЛЯ УХОДА</span></li>
                    <li><span class="span__shop">Набор для путешествий «Baxter of California»</span></li>
                </div>
            </div>
                    ...
                    <div class="inner__container">
                        <div class="shop__item">
                            ...
                            <div class="item__gallery">
                                <div class="item__img"><img class="imgg" src="../барбершоп/imgs/Layer100000000.png" alt="" width="573px" height=""/></div>
                                <div class="item__img"><img class="imgg" src="../барбершоп/imgs/Layer 45.png" alt=""/></div>
                                <div class="item__img"><img class="imgg" src="../барбершоп/imgs/Layer 46.png" alt=""/></div>
                                <div class="item__img"><img class="imgg" src="../барбершоп/imgs/Layer 47.7.png" alt=""/></div>
                            </div>
                            ...
                            <div class="item__info">
                                <div class="info__list">
                                    <div class="if__else">
                                        ...
                                        <li class="if__else-li">артикул: SPIDER-MAN</li>
                                    </div>
                                    <div class="info__list-p">
                                    ...
                                    <div class="item__price">
                                        <div class="price__wrapper"><li>2900 #8381</li></div>
                                        <div class="akor__wrapper"><a class="button button__buy">купить</a></div>
                                    </div>
                                </div>
                                <div class="item__set">
                                    <div class="set__h3"><h3>В набор входят:</h3></div>
                                    <div class="set__list">
