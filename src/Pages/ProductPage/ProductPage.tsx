        ...
        <div className="productPage">
            ...
            <div className="inner__container">
                ...
                <div className="breadcrumbs">
                    ...
                    <li><span className="span__shop">{product.title}</span></li>
                </div>
            </div>
                        ...
                        <div className="product__info">
                            <div className="info__list">
                                <div className="amount">
                                    ...
                                    <li>{product.amount > 0 ? 'есть в наличии' : 'нет в наличии'}</li>
                                    <li className="amount-li">артикул: {id}</li>
                                </div>
                                <div className="info__list-p">
