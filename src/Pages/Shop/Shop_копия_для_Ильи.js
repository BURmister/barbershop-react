...
function Shop(props) {
    ...
    //логика зпроса с помощью axios на mockapi
    React.useEffect(() => {
        props.isHeader();
            ...
            <div className="Shop__h2"><h2>наш магазин</h2></div>
                <div className="inner__container">
                    <div className="shop">
                        ...
                        {/*ЗДЕСЬ ПРОИСХОДИТ РЕНДЕР КАРТОЧЕК*/}
