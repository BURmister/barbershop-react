...
import { fetchShopCards, getShopCards } from '../../redux/slice/shopCardsSlice'
import { changeSelectedSort } from '../../redux/slice/sortSlice'
import { addItem, fetchCart } from '../../redux/slice/cartSlice'
...
const Shop: React.FC<ShopProps> = ({isHeader}) => {
    ...
    React.useEffect(() => {
        if (isMounted.current) {
            const queryString = qs.stringify({
                ...
                filterBrand: filterBrand.data,
                sortBy: selectedSort.property,
                order: selectedSort.type
            })
            ...
            <div className="inner__container">
                <div className="shop__search-wrapper">
                    ...
                    <div className="p-relative">
                        { localSearch && <img className="clear" src={iconClear} onClick={() => onSearchClear() }  alt="X" /> }
                        <input ref={searchRef} className="search__input" onChange={onSearchInput} value={localSearch} placeholder="Search" />
                        <Sort />
                    ...
                    <div className="shop">
                        ...
                        <div className="shop__list">  
                            ...
                            <Pagination 
                                ...
                                pageCount={pageCount}
                                // totalItems={renderShopCards.length}
                            />
