...
const Contacts: React.FC<ContactsProps> = ({isHeader}) => {

    const activePage = useSelector((state: any) => state.activePage.value)
    const dispatch = useDispatch()

    React.useEffect(() => {
        dispatch(changeActivePage(4))
        isHeader()
        window.scrollTo(0, 0)
    }, [])
        ...
        <div className="Contacts__main"> 
            ...
            <div className="Contacts__inner__container">
                ...
                <div className="breadcrumbs">
                    ...
                    <li><span className="span__shop">КОНТАКТЫ</span></li>
                </div>
            </div>
                    ...
                    <div className="Contacts__info">
                        ...
                        <div className="Contacts__wrapper">
                            <div className="Contacts">
                                ...
                                <div >
                                    <p className="Contacts__item-p"> Барбершоп Бородинский <br/>
                                        Адрес: г. Санкт-Петербург, <br/>
                                        Б. Конюшенная, д. 19/8 <br/>
                                        Телефон: 000-00-00-00<br/>
                                        <br/>
                                        наша почта: <br/>
                                        emailboroda@gmail.com
                                    </p>
                                </div>
                                <div className="Contacts__item-time">
                                    <p className="Contacts__item-p"> Время работы:<br/>
