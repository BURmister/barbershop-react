...
const PriceList: React.FC<PriceListProps> = ({isHeader}) => {
                        ...
                        <div className="PriceList__price__list-wrapper">
                            ...
                            <div className="PriceList__priceS__wrapper">
                                ...
                                <div className="PriceList__service">
                                    <div className="PriceList__service__h3"><h3>цены на услуги<br/> наших мастеров:</h3>
                                    <div className="PriceList__service__list">
                                        <table>
                                            <tr>
                                                <td><li>стрижка</li></td>
                                                <td><li>1500 ₽</li></td>
                                            ...
                                            <tr>
                                                <td><li>стрижка бороды</li></td>
                                                <td><li>500 ₽</li></td>
                                            </tr>
                                            <tr>
                                                <td><li>накрутка усов</li></td>
                                                <td><li>350 ₽</li></td>
                                            </tr>
                                        </table>
                                    </div>
                                ...
                                <div className="PriceList__info__list">
